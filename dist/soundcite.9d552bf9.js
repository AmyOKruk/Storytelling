...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/soundcite.js":[function(require,module,exports) {
;
...
(function (window, document, callback) {
  ...
  function load_popcorn(version, cb) {
    ...
    if (loaded_p) {
      ...
      script.src = '//s3.amazonaws.com/cdn.knightlab.com/libs/soundcite/latest/js/soundcite.min.js';
  ...
  function normalize_background_color(str) {
    ...
    if (match_group) {
      ...
      if (match_group) {
        var hex_to_int = function hex_to_int(hex) {
  ...
  var update_playing_element = function update_playing_element(el, percentage) {
...
},{}]},{},["scripts/soundcite.js"], null)
//# sourceMappingURL=/soundcite.9d552bf9.js.map