...
},{}],"scripts/chart-2.js":[function(require,module,exports) {
"use strict";
...
var height = 300 - margin.top - margin.bottom; // append the svg object to the body of the page
...
function ready(data) {
  ...
  var countries = ['Spain', 'Brazil', 'Guatamala', 'Peru', 'Ecuador', 'Bolivia', 'Colombia', 'Paraguay', 'Chile', 'Uruguay', 'Dominican Republic', 'Costa Rica', 'Nicaragua', 'Honduras', 'El Savador', 'Panama', 'Mexico'];
  data = data.filter(function (d) {
    return countries.indexOf(d.group) !== -1 && countries.indexOf(d.variable) !== -1;
  });
  ...
  svg.selectAll().data(data, function (d) {
    ...
    d3.selectAll('text' + '.' + this.getAttribute('class')).style('font-size', 14);
    d3.selectAll('text' + '#' + this.getAttribute('id')).style('font-size', 14);
  ...
  d3.select('#step-one').on('stepin', function () {
    svg.append('rect').attr('width', 13).attr('height', 189).attr('x', 12).attr('y', 0).attr('stroke', 'orange').attr('fill', 'none').attr('stroke-width', 3).transition();
    svg.selectAll('text#brazil').attr('fill', 'orange').attr('font-weight', 700);
  });
...
},{"d3":"../node_modules/d3/index.js","/data/nodes5.csv":"data/nodes5.csv"}]},{},["scripts/chart-2.js"], null)
//# sourceMappingURL=/chart-2.82e0066a.js.map