...
},{}],"scripts/matrix.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#matrix-graph').append('svg').attr('width', width + margin.left + margin.right).attr('height', height + margin.top + margin.bottom).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
...
},{"d3":"../node_modules/d3/index.js","/data/nodes5.csv":"data/nodes5.csv"}]},{},["scripts/matrix.js"], null)
//# sourceMappingURL=/matrix.092d8e69.js.map