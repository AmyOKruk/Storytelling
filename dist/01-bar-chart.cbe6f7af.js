...
var ColorScale = d3.scaleOrdinal().domain(['Asia', 'Europe', 'Africa', 'N. America', 'S. America']).range(['#8dd3c7', '#ffffb3', '#bebada', '#fb8072', '#80b1d3']);
...
function ready(datapoints) {
  ...
  d3.select('#Asia').on('click', function () {
    ...
    svg.selectAll('.asia').attr('fill', '#8dd3c7').raise();
  });
  d3.select('#Africa').on('click', function () {
    console.log('clicked');
    svg.selectAll('rect').attr('fill', 'lightgrey');
    svg.selectAll('.africa').attr('fill', '#bebada').raise();
  });
  d3.select('#NAmerica').on('click', function () {
    console.log('clicked');
    svg.selectAll('rect').attr('fill', 'lightgrey');
    svg.selectAll('.namerica').attr('fill', '#fb8072').raise();
  });
  ...
  d3.select('#Reset').on('click', function () {
    console.log('clicked');
    svg.selectAll('rect').attr('fill', 'pink').raise();
  });
  ...
  }).attr('fill', 'pink').attr('x', function (d) {
